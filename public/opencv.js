var opencv = function(Module = {}) {
  ...
  function integrateWasmJS(Module) {
    ...
    var wasmTextFile = Module['wasmTextFile'] || 'opencv_js.wast'
    var wasmBinaryFile = Module['wasmBinaryFile'] || 'opencv_js.wasm'
    var asmjsCodeFile = Module['asmjsCodeFile'] || 'opencv_js.temp.asm.js'
  ...
  memoryInitializer =
    Module['wasmJSMethod'].indexOf('asmjs') >= 0 || Module['wasmJSMethod'].indexOf('interpret-asm2wasm') >= 0 ? 'opencv_js.js.mem' : null
  var STATIC_BUMP = 2883616
  ...
  function __embind_register_class(
    ...
    whenDependentTypesAreResolved([rawType, rawPointerType, rawConstPointerType], baseClassRawType ? [baseClassRawType] : [], function (
      base
    ) {
      base = base[0]
      var baseClass
  ...
  staticSealed = true
  Module['wasmTableSize'] = 4274
  Module['wasmMaxTableSize'] = 4274
